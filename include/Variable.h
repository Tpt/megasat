...
class Variable
{
    ...
    int getId() const;
    bool less(Variable const& b) const;
    bool eless(Variable const& b) const;
...
bool operator<(Variable const &a, int const b); /** Tout ceci sert à avoir un ordre arbitraire sur les variables comme dévrit dans le sujet **/
