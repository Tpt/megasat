...
ranges = [(0,1,0),(1,1,0),(2,1,0),(3,1,0),(4,1,0),(0,1,1),(1,1,1),(2,1,1),(3,1,1),(4,1,1)]
...
while nbVar <= maxVar :
    ...
    for p in ranges :
        ...
        while it < itMax :
            popen("./../../gen/genGraphe "+str(nbVar)+" "+str(nbVar*2)+" temp_var.col")
            temps = time.time()
            popen("./../../colorie 4 temp_var.col "+heuristiques[h]+" "+wl[w]+" "+cl[c])
